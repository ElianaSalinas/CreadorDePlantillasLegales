...
_______________________________          _______________________________
  ...
  FROM (VALUES
    ...
    ('penalidad_diaria_porcentaje', 18),
    ('vehiculo_anio', 19),
    ('vehiculo_chasis', 20),
    ('vehiculo_color', 21),
    ('vehiculo_marca', 22),
