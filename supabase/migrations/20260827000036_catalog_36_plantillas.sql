...
-- PARTE 36 de 42: plantillas 211–216. Requiere la parte 0.
...
_______________________________          _______________________________
  ...
  FROM (VALUES
    ...
    ('parte_primera_razon_social', 27),
    ('parte_primera_representante_cargo', 28),
    ('parte_primera_rnc', 29),
    ('parte_primera_tipo_documento', 30),
    ('parte_primera_tipo_parte', 31),
    ('parte_segunda_cantidad', 32),
    ('parte_segunda_cedula', 33),
    ('parte_segunda_domicilio', 34),
    ('parte_segunda_genero', 35),
    ('parte_segunda_miembro2_cedula', 36),
    ('parte_segunda_miembro2_domicilio', 37),
    ('parte_segunda_miembro2_nombre', 38),
    ('parte_segunda_miembro3_cedula', 39),
    ('parte_segunda_miembro3_domicilio', 40),
    ('parte_segunda_miembro3_nombre', 41),
    ('parte_segunda_miembro4_cedula', 42),
    ('parte_segunda_miembro4_domicilio', 43),
    ('parte_segunda_miembro4_nombre', 44),
    ('parte_segunda_nacionalidad', 45),
    ('parte_segunda_nombre', 46),
    ('parte_segunda_razon_social', 47),
    ('parte_segunda_representante_cargo', 48),
    ('parte_segunda_rnc', 49),
    ('parte_segunda_tipo_documento', 50),
    ('parte_segunda_tipo_parte', 51),
    ('precio_venta_letras', 52)
  ) AS t(tag, ord)
  JOIN variables v ON v.tag = t.tag AND v.org_id IS NULL
  ON CONFLICT DO NOTHING;
END $$;
